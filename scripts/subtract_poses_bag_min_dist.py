...
if __name__ == '__main__':
    ...
    t_diff = t_maxs-t_mins
    min_t_idx = np.argmin(t_diff)+accel_idxs.start
    min_distance = get_distance_bag(bag_paths[min_t_idx], t_mins[min_t_idx], t_maxs[min_t_idx], rotational=rotational)
    ...
    for bag_path, save_path, t_min, t_max in zip(bag_paths, save_paths, t_mins_all, t_maxs_all):
        main(tC, bag_path, save_path, t_min, np.inf, pose_amcl_topic, pose_mocap_topic, min_distance, rotational=rotational)
